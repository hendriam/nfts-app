...
import GetOurAppImage from "../assets/images/Other_12.svg";

export default function GetOurApp2() {
    return (
        <section className="grid grid-col-2 sm:grid-cols-4 items-center my-28 text-[#F8F0F0]">
